...
import { createInvestTransactionData, createRedeemTransactionData, getBalanceOf, getFundMetrics } from "../../utils/contract"
...
export class InvestmentService {
    ...
    static getFundBalance = async (investor: string, fund: string, chainId: number) => {
    ...
    static getFundStats = async (fund: string) => {
        ...
        if (!fundToken) throw new APIError(`FundToken with address ${fund} not found`)
